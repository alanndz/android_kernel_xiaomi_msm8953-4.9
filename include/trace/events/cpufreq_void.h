#undef TRACE_SYSTEM
#define TRACE_SYSTEM cpufreq_void

#if !defined(_TRACE_CPUFREQ_VOID_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_CPUFREQ_VOID_H
...
DEFINE_EVENT(set, cpufreq_void_setspeed,
	TP_PROTO(u32 cpu_id, unsigned long targfreq,
	     unsigned long actualfreq),
	TP_ARGS(cpu_id, targfreq, actualfreq)
);
...
DEFINE_EVENT(loadeval, cpufreq_void_target,
	    TP_PROTO(unsigned long cpu_id, unsigned long load,
		     unsigned long curtarg, unsigned long curactual,
		     unsigned long newtarg),
	    TP_ARGS(cpu_id, load, curtarg, curactual, newtarg)
...
DEFINE_EVENT(loadeval, cpufreq_void_already,
	    TP_PROTO(unsigned long cpu_id, unsigned long load,
		     unsigned long curtarg, unsigned long curactual,
		     unsigned long newtarg),
	    TP_ARGS(cpu_id, load, curtarg, curactual, newtarg)
...
DEFINE_EVENT(loadeval, cpufreq_void_notyet,
	    TP_PROTO(unsigned long cpu_id, unsigned long load,
		     unsigned long curtarg, unsigned long curactual,
		     unsigned long newtarg),
	    TP_ARGS(cpu_id, load, curtarg, curactual, newtarg)
...
TRACE_EVENT(cpufreq_void_boost,
...
TRACE_EVENT(cpufreq_void_unboost,
	    TP_PROTO(const char *s),
	    TP_ARGS(s),
	    TP_STRUCT__entry(
		    __string(s, s)
...
TRACE_EVENT(cpufreq_void_load_change,
...
TRACE_EVENT(cpufreq_void_cpuload,
